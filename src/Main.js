...
count =0;
    ...
    notifyMe (){
      ...
      firebaseApp.database().ref('betaTesters').push().set(document.getElementById('notifyEmail').value);
    ...
    contactUsForm (){
      ...
      firebaseApp.database().ref('queriesFromContactUsForm').push().set({Fullname: fullname,
      Email:email,
      Subject:subject,
      Message:message
    });
        ...
        return (
            <div id="skrollr-body">
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                          ...
                          <li>
                              <a onClick = {this.showLogin} > 
                                <div class="header_list">
                                  Log In
                                  <Dialog open={this.state.loginModal} onClose={this.hideLogin} >
                                 <Login hideLogin={this.Login}  />
                          ...
                          <li>
                              <a onClick = {this.showSignUp}> 
                                <div class="sign_up">
                                  Sign Up
                                  <Dialog open={this.state.signupModal} onClose={this.hideSignUp} >
                                 <Signup hideSignUp={this.Signup}  />
              ...
              <div class="wrapper">
                                 ...
                                 <h5 class="details">
                                  ...
                                  <div class="form-inline" role="form">
                                    <div class="form-group form-group2">
                                      ...
                                      <input id="notifyEmail" type="email" class="form-control transparent form-control2" placeholder="Your email here..."/>
                                    </div>
                                    <button type="submit" class="btn2 btn-danger btn2-fill" onClick={this.notifyMe}>Notify Me</button>
                                  </div>
                             </div>
                          </div>
               ...
               <div class="section section-contact-2" id="contact" role="form">
                      <div class="container">   
                        <div class="text-area">
                            <div class="title add-animation">
                                <h2>Contact Us</h2>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group add-animation animation-1">
                                      ...
                                      <input  id="fullname" placeholder="Nelson Mandela" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div  class="form-group add-animation animation-2">
                                        <label>Your Email</label>
                                        <input  id="email" type="email" placeholder="nelson@eudaimonia.com" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div  class="form-group add-animation animation-3">
                                        <textarea id="message" class="form-control" placeholder="Start typing here..." rows="8"></textarea>
                                    </div>
                                <div>
                                <div class="col-md-2 col-md-offset-5">
                                     <button  class="btn btn-lg btn-black btn-contact"  onClick ={this.contactUsForm}>
